...
class FishService(private val connection: Connection) {
    ...
    private suspend fun insertSampleFish() {
        ...
        create(Fish(
            ...
            imageUrl = "https://www.aquariumcoop.com/cdn/shop/articles/neon-tetra-care-guide.jpg",
            imageGallery = null,
            tempMinC = 22.0,
            tempMaxC = 26.0,
            phMin = 6.0,
        ...
        create(Fish(
            ...
            imageUrl = "https://www.aquariumcoop.com/cdn/shop/articles/guppy-care-guide.jpg",
            imageGallery = null,
            tempMinC = 22.0,
            tempMaxC = 28.0,
            phMin = 6.8,
        ...
        create(Fish(
            ...
            imageUrl = "https://www.aquariumcoop.com/cdn/shop/articles/platy-fish-care-guide.jpg",
            imageGallery = null,
            tempMinC = 20.0,
            tempMaxC = 26.0,
            phMin = 7.0,
